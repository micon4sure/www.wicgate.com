...
const { data, loading, clans } = storeToRefs(store);

const meta = PAGE_META['/statistics']!;
const ogImage = `${DEFAULT_SITE_URL}${DEFAULT_OG_IMAGE}`;
const canonicalUrl = 'https://wicgate.com/statistics';

const breadcrumbs: BreadcrumbItem[] = [
  { name: 'Home', url: 'https://wicgate.com/' },
  { name: 'Statistics', url: canonicalUrl },
];
...
<template>
  <Statistics :data="data" :loading="loading" :clans="clans" />
</template>
