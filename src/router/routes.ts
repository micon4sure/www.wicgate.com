    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          keywords:
            'wic leaderboards, world in conflict rankings, wic player stats, wic top players',
          ogImage: '/og-statistics.jpg',
        },
      },
    ],
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          ...
          keywords:
            'wic crashes, wic troubleshooting, world in conflict fixes, wic technical support',
          ogImage: '/og-faq.jpg',
        },
      },
      {
      ...
      },
      {
        ...
        meta: {
          ...
          keywords:
            'wic server hosting, wic community, world in conflict tournaments, wic player count',
          ogImage: '/og-faq.jpg',
        },
      },
    ],
