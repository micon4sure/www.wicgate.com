...
export const steps = [
  { n: 1, t: 'Install World in Conflict', c: 'Install from GOG, Steam, UPlay or retail DVD. If you do not already own a copy of World in Conflict, we recommend buying one from GOG.' },
  ...
  { n: 3, t: 'Install & Run WIC LIVE', c: 'After installation process has finished, find and click the "INSTALL UPDATE" button in WIC LIVE.' },
  { n: 4, t: 'Create Account & Play', c: 'Launch the game and create an account. From the main menu, click <strong>Multiplayer</strong> -> <strong>Online</strong> and then <strong>Create Account</strong> in the bottom center of the screen. Then, join us in multiplayer!' }
];
