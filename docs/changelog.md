...
- 🎨 **UI: Quick Start Button Smaller on Phones** - Added media query for ≤425px to make hero video Quick Start button more compact on phone screens: reduced position (0.375rem), padding (0.3rem 0.5rem), font-size (0.65rem), and gap (0.2rem) - better touch targets without obscuring video content (Dec 28)
